...
public class Messages {
	...
	public static String brHintBackupCreated = "Backup created:\n{1}";
	public static String brProgressRestoreBookmarks = "Restore bookmarks ...";
	public static String brHintBookmarksRestored = "Restore done ...";
